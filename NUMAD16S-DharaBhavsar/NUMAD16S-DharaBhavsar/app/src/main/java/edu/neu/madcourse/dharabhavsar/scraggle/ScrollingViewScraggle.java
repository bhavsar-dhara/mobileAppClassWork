 ...
 */
public class ScrollingViewScraggle extends View {
   private Drawable mBackground;
   private int mScrollPos;

   public ScrollingViewScraggle(Context context) {
      super(context);
      init(null, 0);
   }

   public ScrollingViewScraggle(Context context, AttributeSet attrs) {
      super(context, attrs);
      init(attrs, 0);
   }

   public ScrollingViewScraggle(Context context, AttributeSet attrs, int defStyle) {
