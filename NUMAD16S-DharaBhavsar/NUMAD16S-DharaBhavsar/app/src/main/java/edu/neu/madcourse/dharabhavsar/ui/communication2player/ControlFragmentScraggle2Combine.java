...
public class ControlFragmentScraggle2Combine extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((ScraggleGameActivity2Combine) getActivity()).onQuitGame();
                getActivity().finish();
            }
        });
        pause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((ScraggleGameActivity2Combine) getActivity()).onPauseGame();
        ...
        resume.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                unmuteToggle.setVisibility(View.INVISIBLE);
                ((ScraggleGameActivity2Combine) getActivity()).onResumeGame();
            }
        });
        muteToggle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ScraggleGameActivity2Combine) getActivity()).toogleMute();
                muteToggle.setVisibility(View.INVISIBLE);
