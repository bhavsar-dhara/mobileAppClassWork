...
//        Log.e("ScraggleFragment", "isPhaseTwo = " + isPhaseTwo);
        ...
        if (!((ScraggleGameActivity2) this.getActivity()).isRestore()) {
...
//            Log.e("nineWords", str);
            for (int small = 0; small < 9; small++) {
                if (!isPhaseTwo) {
//                    Log.e("isRestore", String.valueOf(((ScraggleGameActivity2) getActivity()).isRestore()));
//                    if(!((ScraggleGameActivity2) getActivity()).isRestore()) {
//                to add letters of the words
...
//                                Log.e("WordFound", str);
                                ...
                                refreshBoard(mView);
                                calcGameScore2();
                                ((ScraggleGameActivity2) getActivity()).setScore2(gameScore);
                            }
                        }
                    }
                    ((ScraggleGameActivity2) getActivity()).stopThinking();
...
//            Log.e("WordTEST", "Set All initially");
    ...
    public String getState() {
        ...
        builder.append(',');
        builder.append(((ScraggleGameActivity2) this.getActivity()).getScore2());
        builder.append(',');
        builder.append(((ScraggleGameActivity2) this.getActivity()).isPhaseTwo());
        builder.append(',');
...
//                String.valueOf(((ScraggleGameActivity2) this.getActivity()).isGameEnd()));
        builder.append(((ScraggleGameActivity2) this.getActivity()).isGameEnd());
        builder.append(',');
    ...
    public void putState(String gameData) {
        ...
        ((ScraggleGameActivity2) this.getActivity()).setScore2(gameScore2);
        isPhaseTwo = Boolean.parseBoolean(fields[index++]);
//        Log.e("putSTATE", "isPhaseTwo = " + isPhaseTwo);
        ((ScraggleGameActivity2) this.getActivity()).setIsPhaseTwo(isPhaseTwo);
...
//        }
        ...
        ((ScraggleGameActivity2) this.getActivity()).setIsGameEnd(isGameEndFlag);
        setAvailableFromLastMove(mLastSmall);
        updateAllTiles();
