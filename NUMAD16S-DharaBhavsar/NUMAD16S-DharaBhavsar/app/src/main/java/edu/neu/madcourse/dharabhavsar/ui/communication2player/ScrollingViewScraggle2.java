 ...
 */
public class ScrollingViewScraggle2 extends View {
   private Drawable mBackground;
   private int mScrollPos;

   public ScrollingViewScraggle2(Context context) {
      super(context);
      init(null, 0);
   }

   public ScrollingViewScraggle2(Context context, AttributeSet attrs) {
      super(context, attrs);
      init(attrs, 0);
   }

   public ScrollingViewScraggle2(Context context, AttributeSet attrs, int defStyle) {
